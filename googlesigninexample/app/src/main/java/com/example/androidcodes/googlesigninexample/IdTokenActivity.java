package com.example.androidcodes.googlesigninexample;
...
public class IdTokenActivity extends AppCompatActivity implements
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            ((TextView) findViewById(R.id.status)).setText(getString(R.string.signed_in_fmt,
                    acct.getDisplayName()).concat("\n\n Email-Id : " + acct.getEmail()));

            String idToken = result.getSignInAccount().getIdToken();
            System.out.println("\n\n TOKEN --> " + idToken + "\n\n");
            mIdTokenTextView.setText(getString(R.string.id_token_fmt, idToken));
            mIdTokenTextView.setMovementMethod(new ScrollingMovementMethod());
